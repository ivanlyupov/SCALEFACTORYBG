...
export const plans = [
  ...
  },
  {
    ...
    meta: [
      ...
      ["Срок за готова анимация", "1–3 дни"],
    ],
...
export const contact = {
  title: "Запази среща за твоя бранд",
  highlight: "среща",
  text: "30-минутен разговор, в който разглеждаме продукта ви, избираме стила, който би му паснал, и ви показваме какво бихме пуснали първо.",
  bullets: [
    "Препоръка кой анимационен стил пасва на бранда и аудиторията ви",
    "Ясен план какво бихме пуснали първо и колко бързо",
    "Без ангажимент — решавате след срещата",
  ],
  namePlaceholder: "Име",
  ...
  successMsg: "✓ Готово! Ще се свържем до 1 работен ден, за да насрочим срещата.",
...
export const plansPage = {
  ...
  ctaText: "Запазете среща — ще ви покажем кой стил пасва на бранда ви и какво бихме пуснали първо.",
  ctaButton: "Запази среща",
};
