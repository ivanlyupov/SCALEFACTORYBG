  ...
  steps: [
    {
      ...
      fields: [
        ...
        { id: "brand", label: "Име на бранда/марката", hint: "Veloura", type: "text", required: true },
        ...
        { id: "tone_adjectives", label: "С три до пет думи — какъв е тонът на бранда?", hint: "Топъл · директен · научно обоснован · забавен · луксозен", type: "text", required: false },
        { id: "differentiation", label: "С едно изречение — какво прави марката различна от алтернативите на пазара?", hint: "Единственият крем с 96% натурален състав, клинично тестван в България", type: "textarea", required: false },
        { id: "spokesperson", label: "Има ли лице на бранда — основател, лекар, експерт, инфлуенсър? Ако да — име и роля", hint: "Д-р Мария Иванова — дерматолог и основател", type: "text", required: false },
        { id: "website", label: "Официален уебсайт", hint: "https://veloura.bg", type: "text", required: true },
        { id: "media_mentions", label: "Марката споменавана ли е в медии (телевизия, радио, преса, подкасти)? Кои точно?", hint: "Интервю в „Преди обед“ · статия в Cosmopolitan BG", type: "textarea", required: false },
      ],
    },
    {
      title: "За продукта",
      ...
      fields: [
        { id: "products", label: "Какво точно продавате? (продукт/линия продукти, кратко описание)", hint: "Крем против стрии 150мл — основен продукт · серум за лице", type: "textarea", required: true },
        ...
        { id: "current_offers", label: "Имате ли други активни оферти/промоции в момента? (изредете всички, с точни условия)", hint: "Първа поръчка -15% с код WELCOME до 31.08", type: "textarea", required: false },
        ...
        { id: "certifications", label: "Имате ли сертификати (ISO, CE, клинични изпитания и т.н.)? Посочете точно кои.", hint: "ISO 22716 · дерматологично тестван 2024", type: "textarea", required: false },
      ],
    },
    {
      title: "Аудитории",
      ...
      fields: [
        ...
        { id: "persona_attention", label: "Основна персона — къде прекарва времето си онлайн? (Facebook, Instagram, TikTok, конкретни групи/форуми)", hint: "Instagram Reels · TikTok · групата „Мами БГ“ във Facebook", type: "textarea", required: false },
    ...
    {
      title: "Pain points",
      desc: "Реалните думи на клиентите — не измисляйте, копирайте.",
      fields: [
        { id: "reviews_raw", label: "Можете ли да ни изпратите всички реални отзиви от клиенти, описващи техния опит с вашия продукт?", hint: "Поставете ги тук или дайте линк към папка/скрийншоти", type: "textarea", required: false },
    ...
    {
      title: "Желан резултат",
      desc: "Успехът през очите на клиента.",
      fields: [
    ...
    {
      title: "Отзиви",
      desc: "Доказателствата, върху които градим доверие — само реални и проверими.",
      fields: [
        { id: "testimonials", label: "Имате ли реални клиентски отзиви/истории, които можем да използваме? (текст, скрийншоти, видео — колкото повече, толкова по-добре)", hint: "„След второто дете мислех, че няма смисъл…“ — Деси, 34 + линк към папка", type: "textarea", required: false },
        { id: "stats", label: "Имате ли обобщени данни — брой клиенти, среден рейтинг, брой продадени бройки? Посочете точните цифри и източника им.", hint: "2400 клиентки (Shopify) · 4.8★ от 512 отзива (сайта)", type: "textarea", required: false },
        { id: "clinical", label: "Има ли клинично/научно обосноваване на продукта? Ако да — какво точно е доказано и от кого (независима институция или вътрешно тествано)?", hint: "Дерматологичен тест 2024, независима лаборатория — 87% видим ефект", type: "textarea", required: false },
        { id: "authority", label: "Има ли експертна/авторитетна подкрепа (лекар, специалист, институция)? Кой точно и какви са пълномощията им?", hint: "Д-р Иванова, дерматолог с 15г опит, УМБАЛ София", type: "textarea", required: false },
      ],
    },
    {
    ...
    {
      title: "Успешни формати",
      desc: "Кое е работило — за да го надградим, а не да откриваме топлата вода.",
      fields: [
        ...
        { id: "winning_format_links", label: "За всеки успешен формат — линк/файл с креатива и резултатите му (CTR, CPA, ROAS, брой продажби — каквито метрики имате)", hint: "drive.google.com/... — UGC видео, ROAS 2.9, CPA 18лв", type: "textarea", required: false },
        { id: "failed_formats", label: "Има ли конкретен формат, който категорично не е работил, независимо от съдържанието?", hint: "Статични банери с продукт на бял фон — винаги под 0.5% CTR", type: "textarea", required: false },
      ],
    },
    {
      title: "Досегашен опит",
      desc: "Последна стъпка — уроците от миналите кампании.",
      fields: [
        ...
        { id: "failed_hooks", label: "Има ли конкретни хукове/ъгли/съобщения, които вече знаете, че НЕ работят?", hint: "Отстъпката в заглавието · „revolutionary formula“ ъгълът", type: "textarea", required: false },
      ],
    },
  ],
};
